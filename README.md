...
Add the following to the startup command box
      ...
      curl -s https://raw.githubusercontent.com/DataDog/datadog-aas-linux/latest/datadog_wrapper | bash
...
If you are already using a startup script, add the following curl command to the end of your script:
     ...
     curl -s https://raw.githubusercontent.com/DataDog/datadog-aas-extension/linux-v0.1.5-beta/linux/datadog_wrapper | bash
### Viewing traces
